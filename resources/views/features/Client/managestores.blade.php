...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 d-flex flex-column align-items-center card py-5">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-8 d-flex d-flex flex-column">
                        <div class="p"><span class="font-weight-bold mx-1" style="color: #000">Store
                                Name:</span>
                            <span class="mx-1" style="color: #8C8B96">{{ $storeOwned[0]->name }}</span>
                        </div>
                        <div class="p"><span class="font-weight-bold mx-1" style="color: #000">Address:</span>
                            <span class="mx-1" style="color: #8C8B96">
                                {{ $storeOwned[0]->street }},
                                {{ Str::substr($storeOwned[0]->barangay, 9, Str::of($storeOwned[0]->barangay)->length()) }},
                                {{ Str::substr($storeOwned[0]->city, 6, Str::of($storeOwned[0]->city)->length()) }},
                                {{ Str::substr($storeOwned[0]->state, 4, Str::of($storeOwned[0]->state)->length()) }}
                            </span>
                        </div>
                        <div class="p"><span class="font-weight-bold mx-1" style="color: #000">Landline:</span>
                            <span class="mx-1" style="color: #8C8B96">
                                {{ $storeOwned[0]->landline }}
                            </span>
                        </div>
                ...
                <div class="d-flex flex-column mb-3 align-items-center">
                    ...
                    <div class="mx-2">{{ $storeOwned[0]->description }}</div>
                </div>
                <div class="d-flex flex-row justify-content-center mb-3 align-items-center">
                    ...
                    <div class="mx-2">{{ $storeOwned[0]->type_of_laundry }}</div>
                </div>
                <div class="d-flex flex-row justify-content-center mb-3 align-items-center">
                    <div class="p" style="color: #000">Time Open:</div>
                    <div class="mx-2" id="openingTime">
                        {{ $storeOwned[0]->opening_time }}</div>
                </div>
                <div class="d-flex flex-row justify-content-center mb-3 align-items-center">
                    <div class="p" style="color: #000">Time Close:</div>

                    <div class="mx-2" id="closingTime">{{ $storeOwned[0]->closing_time }}</div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6 d-flex flex-column align-items-center card py-5">
                <form class="col-sm-12 col-md-6 d-flex flex-column align-items-center" method="POST"
                    ...
                    <div class="row my-2 d-flex justify-content-around">
                        <div class="col-xs-3 d-flex align-items-center"><input type="checkbox" value='true' name="pickup"
                                id=""></div>
                    ...
                    <div class="h4 font-weight-bold mt-2 " style="color: #000; letter-spacing: -1.5px">Payment Methods</div>
                    <div class="row my-2 d-flex justify-content-around">
                    ...
                    <div class="row my-2 d-flex justify-content-around">
                        <div class="col-xs-3 d-flex align-items-center"><input type="checkbox" value='true' name="cashless"
                                id=""></div>
                        <div class="col-xs-9 d-flex align-items-center">Cashless</div>
                    </div>
                    <div class="h4 font-weight-bold mt-2" style="color: #000; letter-spacing: -1.5px">GCash QR Code</div>
                    <div class="d-flex">
        ...
        <div class="row d-flex justify-content-center my-5">
            <input type="number" value="{{ $storeOwned[0]->laundry_id }}" class="d-none" name="laundry_id">
