...
@section('content')
    <div class="flex flex-col h-[90vh] w-screen md:h-[85vh]">
        ...
        @if (Session::has('password_reset'))
            <div class="alert alert-success" role="alert">
                <strong>Success!</strong> Your password has beed updated!
            </div>
        @endif
            ...
            <div class="flex justify-center space-y-5 h-full w-full">
                <form action="/customer/login" method="POST"
                    ...
                    <div class="flex flex-col space-x-2 mt-8 items-center">
                        <a class="font-bold text-decoration-underline" href="/customer/reset">Forgot your password?</a>
                        <div class="font-bold">Are you a client? <a href="/login" class="text-decoration-underline">Login
                                here!</a>
                        </div>
                    </div>
