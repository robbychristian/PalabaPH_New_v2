                ...
                <table style="border: none; margin-left: auto; margin-right: auto" cellpadding="0" cellspacing="0" width="600" class="content">
                    ...
                    <tr>
                        <td class="healthy notification">
                            <h1><span class="icon">&excl;</span>Forgot Password</h1>
                            <p>This email is for resetting your password. Ignore this email if you did not request this.</p>
                            <a href="https://palabaph.com/customer/password-reset/{{ $token }}" class="small" style="text-decoration: underline;">Click here to reset your password!</a>
                        </td>
                    </tr>
