                ...
                <table style="border: none; margin-left: auto; margin-right: auto" cellpadding="0" cellspacing="0" width="600" class="content">
                    ...
                    <tr>
                        <td class="critical notification">
                            <h1><span class="icon">&excl;</span>Warning</h1>
                            <p>This email is sent to send you a warning with regards to breaching the terms and condition set by PalabaPH</p>
                            <p class="small">A warning is sent before the admin blocks you from accessing your account.</p>
                        </td>
                    </tr>
